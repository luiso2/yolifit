...
const AIChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: '¡Hola! Soy Yoly AI, tu asistente personal de belleza, estética y trámites notariales. ✨ ¿Tienes dudas sobre nuestros faciales rejuvenecedores, masajes o servicios de notaría? Cuéntame, ¡estoy aquí para consentirte! 🌸🖋️' }
  ]);
            ...
            <div className="p-3 border-t border-white/10 bg-black/40">
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Preguntar sobre faciales, corporales, precios, notaría..."
                  className="flex-1 bg-transparent text-white placeholder-white/30 text-sm focus:outline-none"
                />
                <button
                  onClick={handleSend}
                  disabled={isLoading || !input.trim()}
                  className="bg-[#B19073] p-2 rounded-lg hover:bg-[#EDE5DA] transition-colors disabled:opacity-50"
                  data-hover="true"
                >
